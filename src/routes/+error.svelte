...
<script lang="ts">
    ...
    const suggestions = [
        ...
        { emoji: '💰', title: 'Priser', desc: 'Se hvad en plads koster med tilskud.', href: '/#priser' },
...
<section class="relative flex min-h-screen overflow-hidden bg-white px-4 py-24">
    ...
    <div class="relative mx-auto w-full max-w-3xl">
        ...
        <p class="mx-auto mb-12 max-w-xl text-center text-lg text-gray-500">
            {#if isNotFound}
                Den side du leder efter er enten flyttet, slettet, eller har aldrig eksisteret. Lad os hjælpe dig videre.
            {:else}
        ...
        <div class="mb-6 overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-xl">
            <div class="flex flex-col items-center gap-6 px-8 py-10 sm:flex-row sm:gap-8">
                <div class="flex h-24 w-24 shrink-0 items-center justify-center rounded-3xl bg-brand-100 text-5xl">
                    {isNotFound ? '🧭' : '⚠️'}
                </div>
