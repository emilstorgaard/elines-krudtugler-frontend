		...
		<div class="relative mx-auto max-w-4xl">
			...
			>
				...
				<div class="relative">
					...
					{#if hasBanner}
						<div
							class="group relative mb-6 flex items-center gap-5 overflow-hidden rounded-3xl border border-brand-200/60 bg-linear-to-r from-white via-white to-brand-50/50 px-6 py-6 shadow-lg shadow-brand-900/5 sm:px-8"
						>
							<div
