			...
			<div class="relative">
				<div class="mb-8 text-center">
					...
					>
						...
						Krudtuglernes åbningstider
					</span>
				</div>

				<div class="space-y-2.5">
					{#each [['Mandag', '7.00 - 16.15'], ['Tirsdag', '7.00 - 16.15'], ['Onsdag', '7.00 - 16.15'], ['Torsdag', '7.00 - 16.15'], ['Fredag', '7.00 - 15.30']] as [day, hours]}
						<div
						...
						>
							...
							<span class="font-medium text-gray-600 tabular-nums">{hours}</span>
						</div>
					{/each}
				</div>
				...
				>
					...
					<p class="text-sm font-medium text-gray-700">Special aftale kan laves</p>
				</div>
			</div>
		</div>
	</div>
