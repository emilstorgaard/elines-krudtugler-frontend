				...
				<div class="relative">
					...
					<div class="grid gap-6 md:grid-cols-2">
						{#if parentsItems.length > 0}
							<div
								class="group relative flex flex-col overflow-hidden rounded-3xl border border-brand-200/60 bg-white p-8 shadow-lg shadow-brand-900/5 transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl hover:shadow-brand-900/10"
							>
								<div
