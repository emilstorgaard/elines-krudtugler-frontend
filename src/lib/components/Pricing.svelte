		...
		<div class="relative mx-auto max-w-3xl">
			...
			>
				...
				<div class="relative">
					...
					{#if hasPricingCard}
						<div
							class="relative mb-6 overflow-hidden rounded-3xl border border-brand-200/60 bg-white shadow-xl shadow-brand-900/10"
						>
							...
							{#if p.pricingFinalLabel && p.pricingFinalValue}
								...
								>
									<div>
										<p
											class="mb-1 text-xs font-semibold tracking-[0.15em] text-brand-700 uppercase"
										>
											{p.pricingFinalLabel}
										</p>
									</div>
