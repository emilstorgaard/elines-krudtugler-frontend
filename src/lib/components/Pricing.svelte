            ...
            >
                ...
                <div class="relative">
                    ...
                    {#if hasPricingCard}
                        ...
                        >
                            <div class="h-1 bg-linear-to-r from-brand-400 via-brand-500 to-brand-600 sm:h-1.5"></div>
                            <div class="px-5 py-1 sm:px-8 md:px-10 sm:py-2">
                                {#if p.pricingPriceLabel && p.pricingPriceValue}
                                    ...
                                    >
                                        <span class="text-sm text-gray-500 sm:text-base">{p.pricingPriceLabel}</span>
                                        <span class="text-xl font-bold text-gray-800 tabular-nums sm:text-2xl md:text-3xl">
                                            {p.pricingPriceValue}
                                        </span>
                                    </div>
                                {/if}
                                {#if p.pricingDiscountLabel && p.pricingDiscountValue}
                                    ...
                                    >
                                        ...
                                        <span class="text-lg font-bold text-brand-600 tabular-nums sm:text-xl md:text-2xl">
                            ...
                            {#if p.pricingFinalLabel && p.pricingFinalValue}
                                ...
                                >
                                    ...
                                    <span class="text-2xl font-bold text-gray-900 tabular-nums sm:text-3xl md:text-4xl">
                                        {p.pricingFinalValue}
