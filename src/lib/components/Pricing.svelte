<section id="priser" class="relative overflow-hidden px-4 py-8">
	<div class="relative mx-auto max-w-3xl">
		...
		<div class="grid gap-4 sm:grid-cols-2">
			{#each [{ emoji: '📅', title: '12 måneder om året', desc: 'Der betales alle 12 måneder — tilskuddet fra kommunen udbetales ligeledes alle 12 måneder, men er bagud betalt.' }, { emoji: '🔒', title: 'Pladsgebyr: 2.434 kr.', desc: 'Pladsen er sikret, når kontrakten er underskrevet og gebyret er betalt. Gebyret fratrækkes første måneds betaling.' }, { emoji: '💚', title: 'Gratis indkøring', desc: 'Vi tilbyder en gratis indkøringsperiode, så dit barn kan vænne sig til de nye rammer i sit eget tempo.' }, { emoji: '🍼', title: 'Alder: 0–3 år', desc: 'Pladsen gælder fra barnet er ca. 6 måneder til måneden inden det fylder 3 år.' }] as tile}
				<div
