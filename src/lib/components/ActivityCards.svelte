...
<div
	class="flex gap-4 overflow-x-auto pb-4 sm:grid sm:grid-cols-2 sm:overflow-visible sm:pb-0 lg:grid-cols-3"
	style="-webkit-overflow-scrolling: touch; scrollbar-width: none;"
>
	{#each activities as activity}
		<div
			class="group flex w-64 shrink-0 flex-col rounded-2xl border border-gray-100 bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-brand-200 hover:shadow-lg sm:w-auto"
		>
			<div
