<script lang="ts">
	...
	let ogImageUrl = $derived(ogImage ? mediaSrc(ogImage.url, 'og', 'png') : `${SITE_URL}/logo.png`);
	let ogImageAlt = $derived(ogImage?.name ?? 'Elines Krudtugler – logo');
...
<svelte:head>
	...
	<meta property="og:site_name" content="Elines Krudtugler" />
