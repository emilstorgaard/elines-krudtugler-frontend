<section id="kontakt" class="relative overflow-hidden bg-green-50 px-4 py-24">
	...
	<div class="relative mx-auto max-w-4xl">
		...
		<p class="mb-16 text-center text-lg text-gray-500">Jeg glæder mig til at høre fra dig</p>
					...
					<div>
						...
						<div class="rounded-2xl bg-white/15 p-4 backdrop-blur-sm">
							<p class="text-sm leading-relaxed text-white/90">
								💝 Jeg tilbyder introduktionsforløb, så dit barn kan vænne sig til de nye rammer i
								eget tempo
							</p>
						</div>
					</div>
