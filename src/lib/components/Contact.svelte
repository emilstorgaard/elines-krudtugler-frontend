		...
		>
			<div>
				...
				<p class="mb-8 leading-relaxed text-white/85">
					Er du interesseret i at høre mere eller se vores lokaler? Kontakt mig for en uforpligtende
					snak — jeg svarer altid inden for 24 timer.
				</p>

				<div class="rounded-2xl bg-white/15 p-4 backdrop-blur-sm">
					<p class="text-sm leading-relaxed text-white/90">
						💝 Jeg tilbyder introduktionsforløb, så dit barn kan vænne sig til de nye rammer i eget
						tempo
					</p>
				</div>
			</div>
