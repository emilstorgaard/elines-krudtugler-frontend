	...
	<div class="relative mx-auto max-w-6xl">
		...
		<div class="grid items-center gap-12 md:grid-cols-2">
			...
			<div class="relative">
				...
				<!-- Floating badge -->
				<div
					class="absolute -right-5 -bottom-5 flex items-center gap-3 rounded-2xl bg-white px-5 py-4 shadow-lg"
				>
					<span class="text-3xl">
			...
			<div class="space-y-6">
				<div>
					...
					<p class="text-lg leading-relaxed text-gray-600">
						...
						hverdag fyldt med leg, læring og kærlighed.
					</p>
				</div>
